...
public class CameraTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(CameraTestActivity.this, Manifest.permission.CAMERA)
    ...
    private void openCamera() {
        ...
        if(camera != null) {
            ...
            mImageSurfaceView = new ImageSurfaceView(CameraTestActivity.this, camera);
